...
(custom-theme-set-faces 'hoagie
 ...
 '(mode-line ((t (:background "gainsboro" :foreground "black" :box (:line-width (1 . 1) :color "black")))))
 '(mode-line-inactive ((t (:background "white smoke" :foreground "gray" :box (:line-width (1 . 1) :color "gainsboro")))))
 ...
 ;; things I don't think I use at all
